...
ActiveRecord::Schema.define(version: 20181105120211) do
  ...
  create_table "assets", force: :cascade do |t|
    ...
    t.decimal  "value",                   precision: 32, scale: 16, null: false
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
  end
  ...
  add_index "expenses", ["type"], name: "index_expenses_on_type", using: :btree
  ...
  add_index "liabilities", ["type"], name: "index_liabilities_on_type", using: :btree
  ...
  add_index "revenues", ["type"], name: "index_revenues_on_type", using: :btree
